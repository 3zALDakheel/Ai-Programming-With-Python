...
#                                                                             
# PROGRAMMER: Abdulaziz ALDakheel
# DATE CREATED: April 4                                  
# REVISED DATE: April 4 
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        ...
        #
        if key[0] == 'p':
            print(key, ': ', results_stats_dic[key],'%') #round(results_stats_dic[key],1),'%')
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            for key in results_dic:
                if sum(results_dic[key][3:]) == 1: # classifier index 3 and image label is 4
                    
                    print("Real: {:>26}   Classifier: {:>30}".format(results_dic[key][0], #real label index 0 and callsifier label is 1
                                                          results_dic[key][1]))
